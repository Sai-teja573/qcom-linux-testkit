...
---
## Prerequisites
1. The `ls` command must be available in the system PATH.
2. Root access is required to check device nodes.
---
 ## Result Format
...
[INFO] 1970-01-01 00:15:40 - ------------------- Completed kvm_check Testcase ----------------------------
```